...
def check_events(ai_settings, screen, stats, sb, menu, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            check_menu(ai_settings, screen, stats, sb, menu, ship,aliens, bullets, mouse_x, mouse_y)
        elif event.type == pygame.QUIT:
            save_and_quit(stats)
        elif event.type == pygame.KEYDOWN:
            check_keydown_events(event, ai_settings, screen,stats, sb, menu, ship, bullets, aliens)
...
def check_aliens_bottom(ai_settings, stats, sb, menu, screen, ship, aliens, bullets):
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            ...
            ship_hit(ai_settings, stats, sb, menu,screen, ship, aliens, bullets)
            break
